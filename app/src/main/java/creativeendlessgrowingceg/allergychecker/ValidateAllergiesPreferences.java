...
public class ValidateAllergiesPreferences {
    ...
    static HashMap<Integer, Integer> setupPictureToValueID() {
        if(!pictureToId.isEmpty()){
            return pictureToId;
        }
        AtomicInteger atomicInteger = new AtomicInteger(0);
        pictureToId.put(R.drawable.fish,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.shellfish,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.peach,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.milk,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.nuts,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.legumes,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.tomato,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.spice,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.orange,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.seeds,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.wheat,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.halal,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.vegetarian,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.vegan,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.lactovegitarian,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.ovoveg,atomicInteger.addAndGet(1));
        pictureToId.put(R.drawable.pescoveg,atomicInteger.addAndGet(1));
    ...
    static HashMap<Integer, Integer> setupIDToValuePicture() {
        if(!idToPicture.isEmpty()){
            return idToPicture;
        }
        AtomicInteger atomicInteger = new AtomicInteger(0);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.fish);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.shellfish);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.peach);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.milk);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.nuts);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.legumes);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.tomato);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.spice);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.orange);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.seeds);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.wheat);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.halal);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.vegetarian);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.vegan);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.lactovegitarian);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.ovoveg);
        idToPicture.put(atomicInteger.addAndGet(1), R.drawable.pescoveg);
