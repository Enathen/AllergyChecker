...
import creativeendlessgrowingceg.allergychecker.design.adapter.SlidePageAdapter;
import creativeendlessgrowingceg.allergychecker.design.fragments.OnBoardingPagerIndicator;
import creativeendlessgrowingceg.allergychecker.design.fragments.OnboardingPageFragment;
import creativeendlessgrowingceg.allergychecker.design.manager.PageViewManager;
...
public class OnboardingPagerActivity extends ActionBarActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Page p = new Page(0, "#19b3ad", R.drawable.nuts);
        mPagerMgr.addPage(p);
        p = new Page(1, "#354ABC", R.drawable.peach);
        mPagerMgr.addPage(p);
        p = new Page(2, "#23f353", R.drawable.pinapple);
        mPagerMgr.addPage(p);
        p = new Page(3, "#23f353", R.drawable.fruit);
        mPagerMgr.addPage(p);
